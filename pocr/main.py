def main() -> None:
    raise NotImplementedError("CLI has not been re-implemented yet.")
...
#     parser.add_argument("input_file", type=str, help="Path to your input file")
#     parser.add_argument(
#         "-o",
#         "--output",
#         required=False,
...
#     parser.add_argument("-l", "--lang", required=False, default="eng", help="Subtitle language")

#     parser.add_argument(
#         "--indexer",
#         required=False,
#         choices=["ffms2", "lsmas", "auto"],
#         default="auto",
