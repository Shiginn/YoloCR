# Generated by stubsgen -p vsmlrt -o stubs/vsmlrt.pyi
...
def Waifu2x(clip: vs.VideoNode, noise: typing.Literal[-1, 0, 1, 2, 3] = -1, scale: typing.Literal[1, 2, 4] = 2, tiles: int | tuple[int, int] | None = None, tilesize: int | tuple[int, int] | None = None, overlap: int | tuple[int, int] | None = None, model: Waifu2xModel = ..., backend: backendT = ..., preprocess: bool = True) -> vs.VideoNode: ...
...
def ArtCNN(clip: vs.VideoNode, tiles: int | tuple[int, int] | None = None, tilesize: int | tuple[int, int] | None = None, overlap: int | tuple[int, int] | None = None, model: ArtCNNModel = ..., backend: backendT = ...) -> vs.VideoNode: ...
def inference(clips: vs.VideoNode | list[vs.VideoNode], network_path: str, overlap: tuple[int, int] = (0, 0), tilesize: tuple[int, int] | None = None, backend: backendT = ..., input_name: str | None = 'input', batch_size: int = 1) -> vs.VideoNode: ...
...
class BackendV2:
    @staticmethod
    def TRT(*, num_streams: int = 1, fp16: bool = False, tf32: bool = False, output_format: int = 0, workspace: int | None = None, use_cuda_graph: bool = False, static_shape: bool = True, min_shapes: tuple[int, int] = (0, 0), opt_shapes: tuple[int, int] | None = None, max_shapes: tuple[int, int] | None = None, force_fp16: bool = False, use_cublas: bool = False, use_cudnn: bool = False, device_id: int = 0, **kwargs) -> Backend.TRT: ...
    @staticmethod
    def NCNN_VK(*, num_streams: int = 1, fp16: bool = False, device_id: int = 0, **kwargs) -> Backend.NCNN_VK: ...
    @staticmethod
    def ORT_CUDA(*, num_streams: int = 1, fp16: bool = False, cudnn_benchmark: bool = True, device_id: int = 0, **kwargs) -> Backend.ORT_CUDA: ...
    @staticmethod
    def OV_CPU(*, num_streams: int | str = 1, bf16: bool = False, bind_thread: bool = True, num_threads: int = 0, **kwargs) -> Backend.OV_CPU: ...
    @staticmethod
    def ORT_CPU(*, num_streams: int = 1, **kwargs) -> Backend.ORT_CPU: ...
    @staticmethod
    def OV_GPU(*, num_streams: int | str = 1, fp16: bool = False, device_id: int = 0, **kwargs) -> Backend.OV_GPU: ...
    @staticmethod
    def ORT_DML(*, device_id: int = 0, num_streams: int = 1, fp16: bool = False, **kwargs) -> Backend.ORT_DML: ...
    @staticmethod
    def MIGX(*, fp16: bool = False, opt_shapes: tuple[int, int] | None = None, **kwargs) -> Backend.MIGX: ...
    @staticmethod
    def OV_NPU(**kwargs) -> Backend.OV_NPU: ...
    @staticmethod
    def ORT_COREML(*, num_streams: int = 1, fp16: bool = False, **kwargs) -> Backend.ORT_COREML: ...
    @staticmethod
    def TRT_RTX(*, num_streams: int = 1, fp16: bool = False, workspace: int | None = None, use_cuda_graph: bool = False, static_shape: bool = True, min_shapes: tuple[int, int] = (0, 0), opt_shapes: tuple[int, int] | None = None, max_shapes: tuple[int, int] | None = None, device_id: int = 0, **kwargs) -> Backend.TRT_RTX: ...
